...
class _ClipsListScreenState extends State<ClipsListScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text(S.of(context).fetchClips),
                ...
                return PaginationWrapper(
                  ...
                  onLoadMore: () {
                    context.read<ClipsBloc>().add(ClipsListEvent(
                        ...
                        page:
                            state.clipResponse!.pagination!.currentPage! + 1));
                  },
                  scrollableChild: ListView.separated(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      if (index >= state.clips!.length) {
                        ...
                        if (state.isLoading &&
                            state.status == ClipStatus.initial) {
                          ...
                          child: Row(
                            children: [
                              ...
                              Flexible(
                                ...
                                padding: const EdgeInsets.all(5),
                                child: Text(
                                  state.clips![index].description ??
                                      'Description',
                                  maxLines: 2,
                                  style: AppStyles.thickLargeTextStyle,
                                ),
                              ))
                            ],
                          ));
