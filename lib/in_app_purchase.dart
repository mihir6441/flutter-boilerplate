...
/// paste your product_ids here from app/play store
/// note: product_ids should be same
...
class InAppPurchaseState extends State<InAppPurchaseScreen> {
  ...
  /// initialize store where we can get
